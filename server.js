...
io.on("connection", (socket) => {
  ...
  socket.on("joinRoom", ({ roomId, nickname, permUid }) => {
    ...
    // ⭐ roomUI 호환 — players만 보냄 (절대 구조 변경 X)
