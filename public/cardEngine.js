...
function waveSvg(topColor, bottomColor) {
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="220" height="320" viewBox="0 0 220 320">
      ...
      <path d="M-10,150 C40,110 70,190 120,150 C160,120 190,180 240,145" fill="none" stroke="rgba(255,255,255,0.22)" stroke-width="8" stroke-linecap="round"/>
      <path d="M-10,150 C40,110 70,190 120,150 C160,120 190,180 240,145" fill="none" stroke="rgba(0,0,0,0.18)" stroke-width="2" stroke-linecap="round"/>
    </svg>
  `.trim();
